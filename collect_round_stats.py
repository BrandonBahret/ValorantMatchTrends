...
-----
    ...
    python collect_round_stats.py --name 0dmg --tag sadge --out my_stats.js
...
The script:
  ...
  5. Writes round_stats.js (consumed by index.html via <script src="round_stats.js">)
"""
...
def run(
    ...
    with open(out, "w", encoding="utf-8") as fh:
        fh.write("// Auto-generated by collect_round_stats.py — do not edit manually\n")
        fh.write("window.ROUND_STATS_DATA = ")
        json.dump(output, fh, indent=2, ensure_ascii=False)
        fh.write(";\n")
    print(f"  JS export     : {out}")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--out",  default="round_stats.js",
                        help="Output JS path (default: round_stats.js)")
